function [figout, mat] = DoSectionFourPlots_comp(fignum, basic,advanced,PathReps,ProductionReps,graphicsuffix)
...
text(  basic.t0 + basic.tau + basic.TMax ,  plot_lower + 300 , 'n_0 + \tau + T_{max}', 'Fontsize', tmpfontsize) ;
if length(graphicsuffix) == 0
    text(  ( basic.t0 + basic.tau ) / 4.5 , 4500 , 'No trial', 'Fontsize', tmpfontsize);
    text(  ( basic.t0 + basic.tau ) / 4.5,  -4500 , 'No trial', 'Fontsize', tmpfontsize) ;
