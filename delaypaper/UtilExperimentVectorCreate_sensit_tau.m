function [basicvec, advancedvec, legendvec, veclen] =  UtilExperimentVectorCreate_sensit_tau( basic, advanced, basicflag, fieldname, fieldvec)
...
if ~exitflag
    ...
    for i=1:veclen
      ...
      [basicvec(i), advancedvec(i)] =  DelayStructureCompute (basicvec(i), advancedvec(i));%P: added new function here
